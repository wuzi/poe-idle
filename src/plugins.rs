...
use crate::gameplay::{
    enemies_attack, handle_map_selection_requests, handle_map_transitions, move_enemies,
    move_player, player_attack, regenerate_player_health, resolve_combat_outcomes,
    spawn_enemy_packs,
};
...
use crate::ui::{
    ...
    sync_hud_text, sync_inventory_grid, sync_inventory_panel, sync_portal_map_buttons,
    sync_portal_panel, sync_talent_panel, update_item_tooltip,
};
use crate::visual::{
